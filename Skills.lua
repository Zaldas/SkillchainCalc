...
skills.gs = { -- Great Sword
    ...
    [51] = {en='Freezebite',      skillchain={'Induration','Detonation'},        skill=100}, -- HorizonXI
...
skills.scythe = { -- Scythe
    ...
    [101]= {en='Vorpal Scythe',     skillchain={'Transfixion','Scission'},      skill=150}, -- HorizonXI
...
skills.katana = { -- Katana; only NIN has skill
    ...
    [132] = {en='Blade: Chi',    skillchain={'Transfixion','Impaction'},        skill=150}, -- HorizonXI
...
skills.gkt = { -- Great Katana
    ...
    [150] = {en='Tachi: Yukikaze',skillchain={'Induration','Detonation'},       skill=200,  -- HorizonXI
                JobRestrictions={'SAM'}},
...
skills.archery = { -- Archery
    ...
    [193] = {en='Piercing Arrow',  skillchain={'Reverberation','Transfixion'},  skill=40,  -- HorizonXI
                JobRestrictions={'RNG'},
                allowSubjob=true},
    [194] = {en='Dulling Arrow',   skillchain={'Liquefaction','Transfixion'},   skill=80,   -- HorizonXI
                JobRestrictions={'RNG'},
                allowSubjob=true},
    [196] = {en='Sidewinder',      skillchain={'Reverberation','Transfixion','Detonation'},    skill=175,  -- HorizonXI
                JobRestrictions={'RNG'},
                allowSubjob=true},
    [197] = {en='Blast Arrow',     skillchain={'Induration','Transfixion'},     skill=200,  -- HorizonXI
                JobRestrictions={'RNG'}},
...
skills.mm = { -- Marksmanship
    ...
    [209] = {en='Split Shot',      skillchain={'Reverberation','Transfixion'},  skill=40,
                JobRestrictions={'RNG','COR'},
                allowSubjob=true},
    [210] = {en='Sniper Shot',     skillchain={'Liquefaction','Transfixion'},   skill=80,   -- HorizonXI
                JobRestrictions={'RNG','COR'},
                allowSubjob=true},
    [212] = {en='Slug Shot',       skillchain={'Reverberation','Transfixion','Detonation'},    skill=175,  -- HorizonXI
                JobRestrictions={'RNG','COR'},
                allowSubjob=true},
    [213] = {en='Blast Shot',      skillchain={'Induration','Transfixion'},     skill=200,  -- HorizonXI
                JobRestrictions={'RNG'}},
