...
jobs.PUP = {
    ...
    weapons = {
        ...
        dagger    = { skillRank = 'C-' },
        club      = { skillRank = 'D' },
        automaton = { skillRank = 'A+' },  -- Automaton combat skill follows weapon-rank curves per frame (Valoredge melee and Sharpshot ranged = A+ with the matching head, Harlequin = B-, other frame skills = C+); this flat bucket covers all frames, so A+ is the highest common ceiling that doesn't exclude any frame's WS below its own cap
    },
}
